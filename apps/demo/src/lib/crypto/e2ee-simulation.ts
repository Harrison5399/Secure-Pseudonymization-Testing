...
import { base64ToBytes, bytesToBase64, randomBytes, toArrayBuffer, utf8ToBytes, bytesToUtf8 } from "@/lib/crypto/encoding";
import type { DeviceKeySet } from "@/lib/crypto/types";
...
// Compatibility helpers kept so the current educational UI keeps working.
